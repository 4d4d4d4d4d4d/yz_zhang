...
> 截至 2026-07-18：MVP + V1~V26 全批次完成。
> 后端 **206 tests** + 前端 **29 tests**（core 23 + web 6）全绿。
...
| 短信/eKYC 实名 | 模拟验证码 `123456` | `account` 模块验证入口 |
| 持牌支付/提现/开票 | 模拟充值提现（整数分账本已备） | `wallet` 模块支付网关接口 |
